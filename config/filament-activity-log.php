...
return [
    ...
    */
    ...
    /*
     * Disabled on purpose: the InteractsWithRequest trait already injects
     * ip_address and user_agent via beforeActivityLogged(). Enabling this
     * would double-write the same keys into properties.
     */
    'auto_context' => [
        'enabled' => false,
        'capture_ip' => true,
