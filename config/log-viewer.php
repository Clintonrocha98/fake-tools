...
return [
    ...
    */
    ...
    'enabled' => env('LOG_VIEWER_ENABLED', default: true),

    'api_only' => env('LOG_VIEWER_API_ONLY', default: false),
    ...
    */
    ...
    'exclude_ip_from_identifiers' => env('LOG_VIEWER_EXCLUDE_IP_FROM_IDENTIFIERS', default: false),
