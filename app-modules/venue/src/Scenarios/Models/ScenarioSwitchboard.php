...
namespace He4rt\Venue\Scenarios\Models;

use App\Models\BaseModel;
use He4rt\Venue\Database\Factories\Scenarios\ScenarioSwitchboardFactory;
 ...
 * ANTES de qualquer endpoint ({@see \He4rt\Venue\Scenarios\Http\Middleware\ApplyScenarioSwitches}).
...
#[Table(name: 'venue_scenario_switches')]
