 ...
 * Qual de `from`/`to` é base ou quote depende do {@see \He4rt\FakeBinance\Ledger\Enums\Side}
 * passado a {@see \He4rt\FakeBinance\Ledger\Actions\SwapLedgerAssets} — este DTO não
