...
use He4rt\FakeBinance\Database\Factories\Fiat\FiatOrderFactory;
...
#[Table(name: 'fake_binance_fiat_orders')]
final class FiatOrder extends BaseModel
{
     ...
     * gravado em `status` (ver {@see \He4rt\FakeBinance\Fiat\Actions\GetFiatOrderDetail}),
